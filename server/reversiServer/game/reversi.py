...
class reversi:
    def __init__(self, grid = None, turn = None, moveId = 0, lastTurn = GridState.BLACK, over = False, additionalMeta = {}, lastMove = "", lastFlipped = [], lastMoveTime = None, black=50, white=50):
